...
def convert_alpaca(
    ...
    """
    outputs = {"prompt": [], "response": [], "system": [], "tools": [], "images": [], "cress_weight":[]}
    ...
    for i in range(len(examples[dataset_attr.prompt])):
        ...
        outputs["cress_weight"].append(examples[dataset_attr.cress_weight][i] if dataset_attr.cress_weight else [])
    return outputs
    ...
    features = Features.from_dict(
        {
            ...
            "images": [{"_type": "Image"}],
            "cress_weight": [{"_type": "Value", "dtype": "float"}]
        }
    )
    kwargs = {}
